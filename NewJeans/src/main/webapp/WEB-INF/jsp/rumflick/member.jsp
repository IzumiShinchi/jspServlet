...
function goPopup(){
	var pop = window.open("/rumflick/jusopopup.do","pop","width=570,height=420, scrollbars=yes, resizable=yes"); 
}
...
function idCheck(){
	var pop = window.open("/rumflick/idcheck.do","pop","width=570,height=220, scrollbars=yes, resizable=yes"); 
}
</script>
</head>
<body>
