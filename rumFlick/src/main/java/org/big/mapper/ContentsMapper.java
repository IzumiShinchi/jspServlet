...
public interface ContentsMapper {
	...
	List<ContentsFileDTO> contentsFileList(String contentsCode) throws Exception;
	
	ContentsFileDTO contentsFileInfomation(@Param("fileIdx") int fileIdx, @Param("contentsCode") String contentsCode) throws Exception;
